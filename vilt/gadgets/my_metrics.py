...
class F1_Score(Metric):
    ...
    def compute(self, use_sigmoid=True):
        ...
        if use_sigmoid:
            all_logits = torch.sigmoid(all_logits)
        F1_Micro = f1_score(all_logits, all_targets, average='micro', task='binary')
        F1_Macro = f1_score(all_logits, all_targets, average='macro', num_classes=23, task='binary')
        F1_Samples = f1_score(all_logits, all_targets, average='samples', task='binary')
        F1_Weighted = f1_score(all_logits, all_targets, average='weighted', num_classes=23, task='binary')
